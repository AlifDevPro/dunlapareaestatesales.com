    ...
    <section className={Style.header}>
      <div className="container">
        <div className={Style.headerWrapper}>
          ...
          <p>
          Experience the best estate sales in Dunlap with Five Star Estate Liquidations. Our professional and experienced team is ready to help you transition through life&apos;s changes by maximizing the value of your estate.`
          </p>
          <div>
